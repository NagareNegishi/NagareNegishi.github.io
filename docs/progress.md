...
| 5 | Products section | Done | `ProductCard`, `ProductSection`, Nav + App all wired; stub images pending real screenshots |
| 6 | ImageDisplay enhancements | Done | Outside arrows, fade transition (250ms), image counter, full-viewport lightbox with in-lightbox nav arrows |
...
| 2026-06-24 | SectionCard: border + shadow, no bg fill | Keeps page color consistent; border + shadow-sm define the card shape without adding a white layer |
